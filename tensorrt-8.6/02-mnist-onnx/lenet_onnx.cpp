...
int main()
{
    ...
    std::string engine_path = "tensorrt-8.6/02-mnist-onnx/artifacts/lenet.engine";
    std::string input_path = "tensorrt-8.6/02-mnist-onnx/artifacts/input.bin";
    // 注意：Python 端保存的 output_pytorch.bin 已过 softmax，直接是概率
    std::string pytorch_output_path = "tensorrt-8.6/02-mnist-onnx/artifacts/output_pytorch.bin";
    std::string onnx_file = "tensorrt-8.6/02-mnist-onnx/artifacts/lenet.onnx";
